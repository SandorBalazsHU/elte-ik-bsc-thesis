...
void GUI::helpWindow() {
	if (ImGui::Begin("Traffic Simulator Help", &helpWindowStatus, NULL)) {
		...
		ImGui::Separator();
		ImGui::Text("");
		ImGui::Text("For the full documentation see: \nhttps://github.com/SandorBalazsHU/elte-ik-bsc-thesis/tree/master/thesis");
		ImGui::Text("");
		ImGui::Text("       "); ImGui::SameLine();
		ImGui::Image((void*)(intptr_t)objectStorage->getTexture("help_01.png"), ImVec2(600, 319));
		ImGui::Text("");
		ImGui::Text("A common use-case:");
		ImGui::Text("");
		ImGui::Text("1.) Open a map with File/open option, or edit a map:");
		ImGui::Text("    - For the edit controls see: Help/Controls");
		...
		ImGui::Text("    - Add Model layout elements for designing.");
		ImGui::Text("    - Save the map if you edited a new one.");
		ImGui::Text("");
		ImGui::Text("       "); ImGui::SameLine();
		ImGui::Image((void*)(intptr_t)objectStorage->getTexture("help_02.png"), ImVec2(600, 319));
		ImGui::Text("");
		ImGui::Text("2.) Click to Finalize for preparing the simulation.");
		ImGui::Text("");
		ImGui::Text("3.) Setting the simulation.");
		ImGui::Text("    - Open the Simulation/Simulation setting window and set the simulation parameters.");
		ImGui::Text("    - Click the start points for the start point settings.");
		ImGui::Text("");
		ImGui::Text("4.) Click to the Run for run the simulation.");
		ImGui::Text("    - You can pause and continue the simulation anytime.");
		ImGui::Text("    - Open the Simulation/Simulation statistics menu for the statistics and road coloring.");
		ImGui::Text("    - Click to a start or an endpoint for its properties.");
		ImGui::Text("    - Click to a vehicle for see its properties.");
		ImGui::Text("    - Click to a road for its properties.");
		ImGui::Text("");
		ImGui::Text("       "); ImGui::SameLine();
		ImGui::Image((void*)(intptr_t)objectStorage->getTexture("help_03.png"), ImVec2(565, 390));
		ImGui::Text("");
		ImGui::Text("5.) The simulation finished, when all vehicles arrived.");
		ImGui::Text("");
		ImGui::Text("6.) After the simulation you can stop it, restart it or you can go back to the edit mode.");
		ImGui::Text("");
		ImGui::Text("7.) You can close the application from the main menu, with the window X button, or the ESC button.");
		ImGui::Text("");
		ImGui::Separator();
		if (ImGui::Button("Close")) {
